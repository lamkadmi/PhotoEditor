...
import com.component.photoEditor.utils.BitmapUtil;
import com.component.photoEditor.utils.RxAsyncTask;
...
public class PhotoEditor implements BrushViewChangeListener {
    ...
    public void addImage(Bitmap desiredImage) {
        ...
        multiTouchListener.setOnGestureControl(new MultiTouchListener.OnGestureControl() {
            ...
            public void onClick() {
                ...
                frmBorder.setBackgroundResource(isBackgroundVisible ? 0 : R.drawable.border_btn_pointille);
    ...
    public void addText(@Nullable Typeface textTypeface, String text, final int colorCodeTextView) {
        ...
        styleBuilder.withTextColor(context, colorCodeTextView);
    ...
    public void editText(@NonNull View view, @Nullable Typeface textTypeface, String inputText, @NonNull int colorCode) {
        final TextStyleBuilder styleBuilder = new TextStyleBuilder();
        styleBuilder.withTextColor(context, colorCode);
        if (textTypeface != null) {
            styleBuilder.withTextFont(textTypeface);
        }
     ...
     */
    public void setPinceauMode(boolean brushDrawingMode) {
     ...
     */
    public void setPinceauSize(float size) {
        if (brushDrawingView != null)
     ...
     */
    public void setPinceauColor(@ColorRes int color) {
        if (brushDrawingView != null)
    ...
    /**
     * @return provide the size of eraser
     * @see PhotoEditor#setPinceauSize(float)
     */
    ...
    /**
     * @return provide the size of eraser
     * @see PhotoEditor#setPinceauColor(int)
     */
    ...
    /**
     * Enregistrez l'image modifiée sous forme de bitmap
     *
    ...
    public void saveAsBitmap(@NonNull final SaveSettings saveSettings,
        ...
        parentView.saveFilter(new OnSaveBitmap() {
            ...
            public void onBitmapReady(Bitmap saveBitmap) {
                new RxAsyncTask<Bitmap>() {
                    @Override
                    public Observable<Bitmap> doInBackGround() {
                        return Observable.just(getBitmap(saveSettings));
                    }
                    ...
                    public void onPostExecute(@Nullable Bitmap bitmap) {
                        if (bitmap != null) {
                            ...
                            onSaveBitmap.onFailure(new Exception("Erreur lors du chargement du bitmap"));
                        }
                    }
                }.execute((AppCompatActivity) context);
...
//                }.execute();
    ...
    @NonNull
    private Bitmap getBitmap(SaveSettings saveSettings) {
        if (parentView != null) {
            parentView.setDrawingCacheEnabled(true);
    ...
    /**
     * Callback lors de l'édition sur {@link PhotoEditorView}
     *
    ...
    /**
     * Vérifiez si les modifications apportées doivent être enregistrées
     *
